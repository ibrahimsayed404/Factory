...
router.get('/production-orders/partner-factories', authenticate, productionTracking.listPartnerFactories);
router.post('/production-orders/partner-factories', authenticate, authorizeAdmin, v.partnerFactoryCreate, productionTracking.createPartnerFactory);
...
router.delete('/production-orders/:id', authenticate, authorizeAdmin, v.idParam, v.productionOrderDelete, productionTracking.deleteOrder);
